          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <a href="<?php echo site_url('Back-Office/Pays_Controller/delete_confirm?id_pays=' . $datas[0]['id_pays']); ?>" style="cursor:pointer">Oui</a>
                  <a href="<?php echo site_url('Back-Office/Pays_Controller/pays'); ?>" class="btn btn-primary" >Non</a>
              </div>
