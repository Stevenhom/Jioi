        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="<?php echo site_url('Back-Office/Site_Controller/form_trait_update?id_site=' . $datas[$i]['id_site']); ?>" style="cursor:pointer;" enctype="multipart/form-data">
