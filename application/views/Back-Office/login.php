            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Cher Administrateur</span>
                </a>
              </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" novalidate action="<?php echo site_url('Back-Office/SController/authentification');?>" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email" class="form-control" id="yourUsername" value="admin@admin" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="pass" class="form-control" id="yourPassword" value="123456" required>
