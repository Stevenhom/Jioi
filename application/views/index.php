            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="text-center">
                  <a href="<?php echo site_url('Back-Office/SController/login'); ?>" class="btn btn-primary">Administrateur</a>
                  <a href="<?php echo site_url('Front-Office/SController/login'); ?>" class="btn btn-primary">Gestionnaire</a>
                  <a href="<?php echo site_url('Welcome/userDashboard'); ?>" class="btn btn-primary">Utilisateur</a>
              </div>
